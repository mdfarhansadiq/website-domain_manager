...
urlpatterns = [
    ...
    path('domain/<int:domain_id>/edit/', views.edit_domain_info, name='edit_domain_info'),
    path('domain/<int:domain_id>/delete/', views.delete_domain_info, name='delete_domain_info'),
